  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={e => {
        e.preventDefault();
        formData.to = current ? '' : formData.to;
        ...
        <div className="form-group">
          <input type="text" placeholder="* Degree or Vertificate" name="degree" value={degree} onChange={(e) => onChange(e)} required />
        </div>
        <div className="form-group">
          <input type="text" placeholder="Field of Stidy" name="fieldofstudy" value={fieldofstudy} onChange={(e) => onChange(e)} />
        </div>
        <div className="form-group">
          <h4>From Date</h4>
